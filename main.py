...
from utils.lr_schedule import adjust_learning_rate, warmup_cosinear
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        warmup_cosinear(optimizer, epoch, args.epochs, lr_min=0.0001, lr_max=0.1, warmup_epoch = 50)
